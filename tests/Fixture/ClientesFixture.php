...
class ClientesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'documento' => ['type' => 'string', 'length' => 15, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'cep' => ['type' => 'string', 'length' => 10, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'logradouro' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'status' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '0 - Inativo | 1 - Ativo |  9 - Excluido', 'precision' => null, 'autoIncrement' => null],
...
'engine' => 'InnoDB', 'collation' => 'utf8_general_ci'
    ...
    public $records = [
        [
            ...
            'estado' => '',
            'status' => 1,
            'created' => '2015-04-05 12:51:18',
            'modified' => '2015-04-05 12:51:18',
            'updated' => '2015-04-05 12:51:18'
        ],
    ];
}
