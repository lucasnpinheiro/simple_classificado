                ...
                <?php foreach ($categorias as $categoria): ?>
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $categoria->id], ['class' => 'btn btn-danger btn-sm', 'confirm' => __('Tem certeza de que deseja excluir este registro?', $categoria->id)]) ?>
                        </td>
                    </tr>
