    ...
    <div class="panel-body">
        ...
        <div class="panel panel-info">
            <div class="panel-body">
                ...
                <?php
                echo $this->Form->input('Banners.posicao', ['class' => 'col-xs-12', 'div' => ['class' => 'col-xs-12 col-md-8'], 'placeholder' => 'Nome', 'required' => false, 'label' => false, 'options' => ['1' => 'Topo', '2' => 'Rodape', '3' => 'Lateral Esquerda']]);
